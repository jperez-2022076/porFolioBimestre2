    ...
    <>
          ...
          <div key={post._id} className="card m-3 row g-0" style={{maxWidth: '18rem', maxHeight: '20rem'}}>
              ...
              <div className="card-body">
                <h5 className="card-title">
                  {post.title + '  '} 
                  <svg onClick={()=> getPost(post)} data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
      ...
      <div className="offcanvas offcanvas-start" tabIndex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        <div className="offcanvas-header">
          <h5 className="offcanvas-title" id="offcanvasExampleLabel">Update your post</h5>
          <button type="button" className="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div className="offcanvas-body">
          <div className="m-3">
            <label htmlFor="" className="form-label">Title</label>
            <input value={post.title} onChange={handleChange} name="title" className="form-control" type="text" />
          </div>
          <div className="m-3">
